...
const sidebarVariants = cva(
  "group relative flex h-full w-full flex-col gap-4 border-r bg-background p-4 transition-[width,opacity,transform] duration-300 ease-in-out",
  {
    variants: {
      variant: {
...
>(({ className, active, icon, children, collapsed = false, ...props }, ref) => (
  <a
    ref={ref}
    className={cn(
      "group flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-all duration-300 ease-in-out hover:bg-gray-200/80 dark:hover:bg-gray-700/80 hover:text-gray-900 dark:hover:text-gray-100 h-10 w-full",
