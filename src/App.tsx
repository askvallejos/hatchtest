            ...
            <div className="flex flex-col h-full space-y-6">
              ...
              <div className="flex-1 min-h-0 relative">
                <Textarea
                  ...
                  className="w-full h-full bg-gray-200/90 dark:bg-gray-950/60 backdrop-blur-sm border-white/40 dark:border-gray-600/40 resize-none font-mono text-sm leading-relaxed placeholder:text-gray-400 pr-12"
                />
                {cypressCode && (
                  <Button
                    variant="ghost"
